...
import { getBrands, createBrand, deleteBrand } from "@/api/productService";
...
export default function Brands() {
  ...
  const filtered = brands.filter((c) =>
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="bg-white rounded-2xl border border-primary-100 shadow-soft overflow-hidden">
          ...
          >
            <h3 className="font-serif font-bold text-neutral-900">New Brand</h3>
            <p className="text-xs text-neutral-500 mt-0.5">
              Add a brand to organise your products
            </p>
          </div>
